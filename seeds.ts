...
export async function runSeeds(connection: Connection): Promise<void> {
  ...
  `);
    ...
    ("Visuel principal — Guide aquarelle débutants", "Illustration d'accompagnement pour l'article.", "/uploads/images/portrait-aquarelle.jpg", "Image principale : Guide aquarelle débutants", TRUE, 1, 1, NULL),
    ("Détail — Guide aquarelle débutants", "Vue complémentaire (croquis ou zoom).", "/uploads/images/materiel-aquarelle.jpg", "Détail : Guide aquarelle débutants", TRUE, 1, 1, 1),
    ...
    ("Détail — Processus créatif", "Vue complémentaire (croquis ou zoom).", "/uploads/images/croquis-preparatoire.jpg", "Détail : Processus créatif", TRUE, 2, 2, 1),
    ...
    ("Détail — Paysage fantastique numérique", "Vue complémentaire (croquis ou zoom).", "/uploads/images/ambiance-paysage-fantasy.jpg", "Détail : Paysage fantastique numérique", TRUE, 2, 4, 4),
    ...
    ("Détail — Palette fantasy", "Vue complémentaire (croquis ou zoom).", "/uploads/images/harmonies-couleurs-fantasy.jpg", "Détail : Palette fantasy", TRUE, 2, 6, 2),
    ...
    ("Détail — Série portraits fantasy", "Vue complémentaire (croquis ou zoom).", "/uploads/images/serie-portraits-fantasy.jpg", "Détail : Série portraits fantasy", TRUE, 2, 8, 3),
    ...
    ("Détail — Portrait numérique avancé", "Vue complémentaire (croquis ou zoom).", "/uploads/images/rendu-portrait-numerique.jpg", "Détail : Portrait numérique avancé", TRUE, 2, 10, 4),
    ("Visuel principal — Scène narrative", "Illustration d'accompagnement pour l'article.", "/uploads/images/scene-narrative.jpg", "Image principale : Scène narrative", TRUE, 1, 11, NULL),
    ...
    ("Détail — Étude des mains", "Vue complémentaire (croquis ou zoom).", "/uploads/images/croquis-mains.jpg", "Détail : Étude des mains", TRUE, 2, 12, 1),
    ...
    ("Visuel principal — Design de personnage", "Illustration d'accompagnement pour l'article.", "/uploads/images/design-personnage.jpg", "Image principale : Design de personnage", TRUE, 2, 14, 3),
    ("Détail — Design de personnage", "Vue complémentaire (croquis ou zoom).", "/uploads/images/variations-design-personnage.jpg", "Détail : Design de personnage", TRUE, 2, 14, 4),
    ("Visuel principal — Pinceaux numériques", "Illustration d'accompagnement pour l'article.", "/uploads/images/pinceaux-numeriques.jpg", "Image principale : Pinceaux numériques", TRUE, 1, 15, 1),
    ...
    ("Visuel principal — Commande illustration", "Illustration d'accompagnement pour l'article.", "/uploads/images/workflow-commande.jpg", "Image principale : Commande illustration", TRUE, 2, 16, 2),
    ...
    ("Visuel principal — Routine croquis 20 min", "Illustration d'accompagnement pour l'article.", "/uploads/images/routine-croquis.jpg", "Image principale : Routine croquis 20 min", TRUE, 1, 17, 1),
    ...
    ("Détail — Perspective atmosphérique", "Vue complémentaire (croquis ou zoom).", "/uploads/images/plans-profondeur.jpg", "Détail : Perspective atmosphérique", TRUE, 2, 18, 1),
    ("Visuel principal — Pluie textures lumière", "Illustration d'accompagnement pour l'article.", "/uploads/images/pluie-textures-lumiere.jpg", "Image principale : Pluie textures lumière", TRUE, 1, 19, 4),
    ...
    ("Détail — Anatomie fantasy", "Vue complémentaire (croquis ou zoom).", "/uploads/images/etude-anatomie-fantasy.jpg", "Détail : Anatomie fantasy", TRUE, 2, 20, 2),
    ...
    ("Détail — Créatures hybrides", "Vue complémentaire (croquis ou zoom).", "/uploads/images/silhouettes-creatures-hybrides.jpg", "Détail : Créatures hybrides", TRUE, 2, 22, 1),
    ("Visuel principal — Color script", "Illustration d'accompagnement pour l'article.", "/uploads/images/color-script.jpg", "Image principale : Color script", TRUE, 1, 23, 1),
    ...
    ("Détail — Cheveux dynamiques", "Vue complémentaire (croquis ou zoom).", "/uploads/images/meches-cheveux-dynamiques.jpg", "Détail : Cheveux dynamiques", TRUE, 2, 24, 3),
    ("Visuel principal — Fichiers impression", "Illustration d'accompagnement pour l'article.", "/uploads/images/fichiers-impression.jpg", "Image principale : Fichiers impression", TRUE, 1, 25, NULL),
    ("Détail — Fichiers impression", "Vue complémentaire (croquis ou zoom).", "/uploads/images/checklist-impression.jpg", "Détail : Fichiers impression", TRUE, 1, 25, 4),
    ...
    ("Visuel principal — Storyboard illustrateurs", "Illustration d'accompagnement pour l'article.", "/uploads/images/storyboard-illustrateurs.jpg", "Image principale : Storyboard illustrateurs", TRUE, 1, 27, 1),
    ("Détail — Storyboard illustrateurs", "Vue complémentaire (croquis ou zoom).", "/uploads/images/vignettes-storyboard.jpg", "Détail : Storyboard illustrateurs", TRUE, 1, 27, 2),
    ("Visuel principal — Bibliothèque textures", "Illustration d'accompagnement pour l'article.", "/uploads/images/bibliotheque-textures.jpg", "Image principale : Bibliothèque textures", TRUE, 2, 28, 1),
    ...
    ("Visuel principal — Retouche finale", "Illustration d'accompagnement pour l'article.", "/uploads/images/retouche-finale.jpg", "Image principale : Retouche finale", TRUE, 1, 29, 1),
    ...
    ("Visuel principal — Bilan annuel créatif", "Illustration d'accompagnement pour l'article.", "/uploads/images/bilan-annuel-creatif.jpg", "Image principale : Bilan annuel créatif", TRUE, 2, 30, 2),
  ...
  `);
    ...
    ("Merci pour cet article, la checklist de retouche finale m'aide vraiment à savoir quand m'arrêter.", "approved", NULL, 29, "Camille", "Moreau", "camille.moreau@example.com"),
    ("Très utile ! Les critères de lisibilité et de contraste sont clairs et faciles à appliquer sur mes illustrations.", "approved", NULL, 29, "Nina", "Leroy", "nina.leroy@example.com"),
    ("Excellent rappel sur la sur-retouche. Depuis que je suis cette méthode, mes rendus sont plus propres.", "approved", NULL, 29, "Hugo", "Bernier", "hugo.bernier@example.com")
  `);
}
