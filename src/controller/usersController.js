...
// GET /users/artist
var readArtist = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var artist, enrichedArtist, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, usersModel_1.default.findArtist()];
            case 1:
                artist = _a.sent();
                if (!artist) {
                    (0, httpErrors_1.sendError)(res, 404, "Artiste non trouvé");
                    return [2 /*return*/];
                }
                enrichedArtist = enrichUserWithAvatarUrl(artist);
                res.status(200).json(enrichedArtist);
                return [3 /*break*/, 3];
            case 2:
                err_1 = _a.sent();
                logger_1.default.error("Erreur lors de la récupération de l'artiste :", err_1);
                (0, httpErrors_1.sendError)(res, 500, "Erreur lors de la récupération de l'artiste");
                return [3 /*break*/, 3];
