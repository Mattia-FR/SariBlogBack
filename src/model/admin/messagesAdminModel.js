...
var MESSAGE_SELECT_COLUMNS = "id, firstname, lastname, email, username, ip, subject, `text`, status, user_id, created_at";
// biome-ignore lint/suspicious/noExplicitAny: mysql2 query result typing
var mapRowToMessage = function (row) {
    var _a;
    return ({
        id: row.id,
...
var findById = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, db_1.default.query("SELECT ".concat(MESSAGE_SELECT_COLUMNS, " FROM messages WHERE id = ?"), [id])];
            case 1:
                rows = (_a.sent())[0];
                if (!rows[0])
                    return [2 /*return*/, null];
                return [2 /*return*/, mapRowToMessage(rows[0])];
            case 2:
                err_1 = _a.sent();
...
var updateStatus = function (id, data) { return __awaiter(void 0, void 0, void 0, function () {
    var status_1, result, err_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                status_1 = data.status;
                return [4 /*yield*/, db_1.default.query("UPDATE messages SET status = ? WHERE id = ?", [status_1, id])];
            case 1:
                result = (_a.sent())[0];
...
var deleteOne = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, db_1.default.query("DELETE FROM messages WHERE id = ?", [id])];
            case 1:
                result = (_a.sent())[0];
...
var countByStatus = function (status) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, db_1.default.query("SELECT COUNT(*) as total FROM messages WHERE status = ?", [status])];
            case 1:
                rows = (_a.sent())[0];
...
var findAllPaginated = function (page, limit, status) { return __awaiter(void 0, void 0, void 0, function () {
    var offset, whereClause, countParams, listParams, countResult, total, rows, messages, err_5;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                offset = (page - 1) * limit;
            ...
            case 1:
                _a.trys.push([1, 4, , 5]);
                return [4 /*yield*/, db_1.default.query("SELECT COUNT(*) as total FROM messages ".concat(whereClause), countParams)];
            case 2:
                countResult = (_a.sent())[0];
                total = countResult[0].total;
                return [4 /*yield*/, db_1.default.query("SELECT ".concat(MESSAGE_SELECT_COLUMNS, " FROM messages ").concat(whereClause, " ORDER BY created_at DESC LIMIT ? OFFSET ?"), listParams)];
            case 3:
                rows = (_a.sent())[0];
                messages = rows.map(mapRowToMessage);
                return [2 /*return*/, { messages: messages, total: total }];
            case 4:
                err_5 = _a.sent();
