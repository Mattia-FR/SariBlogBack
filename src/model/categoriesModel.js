...
var findAll = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, db_1.default.query("SELECT id, name, slug, display_order, created_at FROM categories ORDER BY display_order")];
            case 1:
                rows = (_a.sent())[0];
...
var findBySlug = function (slug) { return __awaiter(void 0, void 0, void 0, function () {
    var rows, row, err_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, db_1.default.query("SELECT id, name, slug, display_order, created_at FROM categories WHERE slug = ?", [slug])];
            case 1:
                rows = (_a.sent())[0];
                if (!rows[0])
...
exports.default = { findAll: findAll, findBySlug: findBySlug };
